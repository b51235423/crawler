...
public class Database {
     ...
     */
    public static Database getInstance(String host, int port, String DB, String collection) {
        //double-check locking
        synchronized (Database.class) {
            if (instance == null) {
                instance = new Database(host, port, DB, collection);
            }
        }
        return instance;
    }
     ...
     */
    private Database(String host, int port, String DB, String collection) {
        try {
            //connect to database
